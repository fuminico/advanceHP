...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-teal-50 via-white to-amber-50 overflow-hidden pt-20">
      {/* 背景の装飾 */}
      <div className="absolute top-20 left-10 w-72 h-72 bg-teal-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float" />
      <div className="absolute top-40 right-10 w-72 h-72 bg-amber-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float" style={{ animationDelay: '2s' }} />
      <div className="absolute bottom-20 left-1/3 w-72 h-72 bg-purple-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float" style={{ animationDelay: '4s' }} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            >
              <span className="inline-block bg-gradient-to-r from-teal-100 to-amber-100 px-4 py-2 rounded-full text-sm font-semibold text-teal-700">
                デジタルビジネスのパートナー
              </span>
            </motion.div>
          ...
          >
            <div className="relative">
              {/* 背景装飾 */}
              <div className="absolute inset-0 bg-gradient-to-br from-teal-400 to-amber-400 rounded-3xl transform rotate-6 opacity-20" />
              ...
              <div className="relative bg-white rounded-3xl shadow-2xl p-8">
                <div className="grid grid-cols-2 gap-4">
                  {/* サービスアイコンカード */}
                  {[
                    { icon: '🌐', title: 'ホームページ制作', color: 'from-teal-400 to-teal-600' },
                    { icon: '💻', title: 'システム開発', color: 'from-amber-400 to-amber-600' },
                    { icon: '📊', title: 'マーケティング', color: 'from-coral-400 to-coral-600' },
                ...
                <motion.div
                  ...
                  className="mt-6 p-4 bg-gradient-to-r from-teal-50 to-amber-50 rounded-xl"
                >
